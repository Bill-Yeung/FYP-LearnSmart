...
CREATE TABLE IF NOT EXISTS user_progress (
    ...
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    script_id UUID NOT NULL REFERENCES scripts(id) ON DELETE CASCADE,
    study_session_id UUID REFERENCES user_study_sessions(id) ON DELETE SET NULL,
    current_scene_id VARCHAR(50) NOT NULL,
    completed_scenes JSONB DEFAULT '[]'::JSONB,
    unlocked_clues JSONB DEFAULT '[]'::JSONB,
    collected_evidence JSONB DEFAULT '[]'::JSONB,
...
CREATE TABLE IF NOT EXISTS user_answers (
    ...
    sequencing_order JSONB,
    is_correct BOOLEAN NOT NULL,
    attempt_number INT NOT NULL,
    hints_used INT DEFAULT 0,
    mastery_earned INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS user_learn_later (
    ...
    knowledge_id VARCHAR(50) NOT NULL,
    script_id UUID NOT NULL REFERENCES scripts(id) ON DELETE CASCADE,
    source_scene_id VARCHAR(50),
    source_question_id VARCHAR(50),
    ...
    ai_content_viewed JSONB DEFAULT '{}'::jsonb,
    personal_notes TEXT,
    mastery_level VARCHAR(20) DEFAULT 'unfamiliar' CHECK (mastery_level IN ('unfamiliar', 'familiar', 'proficient', 'mastered')),
    updated_at TIMESTAMP DEFAULT NOW(),
    CONSTRAINT user_learn_later_uc UNIQUE (user_id, script_id, knowledge_id)
);
